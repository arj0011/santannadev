...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="editFormAjax" method="post" action="<?php echo base_url('restaurant/restaurant_update') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6" >
                             <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang('service_name_en');?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="service_name_en" id="service_name_en" placeholder="<?php echo lang('store_name_en');?>" value="<?php echo $results->restaurant_name_en;?>"/>
                                    </div>
                             ...
                             <div class="col-md-6" >
                                <div class="form-group">
                                   <label class="col-md-3 control-label"><?php echo lang('service_name_el');?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="service_name_el" id="service_name_el" placeholder="<?php echo lang('store_name_el');?>" value="<?php echo $results->restaurant_name_el;?>"/>
                                    </div>
                             ...
                             <div class="col-md-12" >
                              <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea  class="form-control" name="service_address_en" id="service_address_en" placeholder="<?php echo lang('store_address_en');?>"><?php echo $results->restaurant_address_en;?></textarea>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3"><i class="fa fa-arrow-circle-o-up"></i> <?php echo lang('english_note');?></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="service_address_el" id="service_address_el" placeholder="<?php echo lang('store_address_el');?>"><?php echo $results->restaurant_address_el;?></textarea>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3"><i class="fa fa-arrow-circle-o-up"></i> <?php echo lang('greek_note');?></span>
                                </div>
  ...
  <!--                          <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="latitude" id="latitude" placeholder="<?php echo lang('latitude');?>" value="<?php echo $results->restaurant_lat;?>"/>
                                    </div>
                                </div>
                            </div>
                          </div>  
                            <div class="col-md-12" >
                             <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="longitude" id="longitude" placeholder="<?php echo lang('longitude');?>" value="<?php echo $results->restaurant_lang;?>"/>
                                    </div>
                                </div>
                            </div>  -->
                            ...
                            <div class="col-md-6" >
                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <div class="file_btn file_btn_logo">
                                              ...
                                              <span class="glyphicon input_img2 logo_btn" style="display: block;">
                                                ...
                                                <span class="ceo_logo">
                                                    <?php if(!empty($results->restaurant_file)){ ?>
                                                        <img src="<?php echo base_url().'uploads/service/'.$results->restaurant_file;?>">
                                                    <?php }else{ ?>
                             ...
                             <input type="hidden" name="id" value="<?php echo $results->restaurant_id;?>" />
                            <input type="hidden" name="exists_image" value="<?php echo $results->restaurant_file;?>" />

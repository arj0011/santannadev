                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_category_name_en" id="menu_category_name_en" placeholder="<?php echo lang('menu_category_name_en');?>" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('menu_category_name_el');?></label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_category_name_el" id="menu_category_name_el" placeholder="<?php echo lang('menu_category_name_el');?>" />
                                    </div>

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_category_name_en" id="menu_category_name_en" value="<?php echo $results->category_name_en;?>" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_category_name_el" id="menu_category_name_el"  value="<?php echo $results->category_name_el;?>"/>
                                    </div>

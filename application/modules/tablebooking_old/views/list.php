                    ...
                    <table class="table table-bordered table-responsive" id="common_datatable_booking">
                        ...
                        <tbody>
                          <?php
                            ...
                            <td><?php echo date('d F Y',strtotime($rows['booking_date']))?></td>
                           ...
                           <?php }
                            ...
                            <a href="javascript:void(0)" onclick="delBooking('<?php echo encoding($rows['id']); ?>')" class="on-default edit-row text-danger"><img width="20" src="<?php echo base_url().DELETE_ICON;?>" /></a><br/>

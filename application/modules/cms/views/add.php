                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                 <label class="col-md-3 control-label"><?php echo lang('description_en');?></label>
                                    <div class="col-md-9">
                                        <textarea class="summernote form-control" name="description_en" id="description_en"></textarea>
                                    </div>
                              ...
                              <div class="col-md-12" >
                                ...
                                <label class="col-md-3 control-label"><?php echo lang('description_el');?></label>
                                    <div class="col-md-9">
                                        <textarea class="summernote form-control" name="description_el" id="description_el"></textarea>
                                    </div>

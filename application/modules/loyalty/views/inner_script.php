<script>
    jQuery('body').on('click', '#submit', function () {
        ...
        $("#" + form_name).validate({
            ...
            messages: {
               "user_id[]": '<?php echo lang('title_en_validation'); ?>',
                ...
                start_date: '<?php echo lang('from_date_validation'); ?>',
                end_date: '<?php echo lang('to_date_validation'); ?>',
   ...
   $('#common_datatable_loyalty').dataTable({
      order: [],
      columnDefs: [ { orderable: false, targets: [4,8] } ]
    });

$('#common_datatable_scan').dataTable({
      order: [],

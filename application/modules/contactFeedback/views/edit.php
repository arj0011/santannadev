                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea type="text" class="form-control" name="service_address_en" id="service_address_en" placeholder="<?php echo lang('store_address_en');?>"><?php echo $results->store_name_en;?></textarea>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3"><i class="fa fa-arrow-circle-o-up"></i> <?php echo lang('english_note');?></span>
                                </div>
                            </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea type="text" class="form-control" name="service_address_el" id="service_address_el" placeholder="<?php echo lang('store_address_el');?>"><?php echo $results->store_name_en;?></textarea>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3"><i class="fa fa-arrow-circle-o-up"></i> <?php echo lang('greek_note');?></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="opening" id="opening" placeholder="<?php echo lang('opening');?>" value="<?php echo $results->open_time;?>"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="closing" id="closing" placeholder="<?php echo lang('closing');?>" value="<?php echo $results->close_time;?>"/>
                                    </div>
                                </div>
                            </div>

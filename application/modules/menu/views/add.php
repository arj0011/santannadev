...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('menu/menu_add') ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                    <input type ="hidden" class="form-control" name="store_id" id="store_id" value="<?php if(!empty($results)){echo $results->store_id;}?>" />
                            ...
                            <div class="col-md-12" >
                             ...
                             <input type="hidden" name="id" value="<?php if(!empty($results)){echo $results->store_id;}?>" />

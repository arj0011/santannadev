                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="form-group">
                                <!-- <label class="col-lg-2 control-label"><?php echo lang('group_name');?></label> -->
                                    ...
                                    <div class="col-lg-10">
                                     <input type="text" class="form-control" name="group_name" id="group_name" placeholder="<?php echo lang('group_name');?>" value="<?php echo $results->group_name;?>"/>
                                ...
                                <label><?php echo lang('age');?></label>
                                   ...
                                   <div class="form-group">
                                       ...
                                       <label><?php echo lang('user_gender');?></label>
                                        </div>
                                        </div>
                                    <div class="col-lg-8">
                                     <div id="dvGender" class="custom_chk chk_box" style="display: none">
                                      ...
                                      <div class="checkbox">
                                     <input type="radio" name="user_gender" id="gender_both" value="BOTH"> <label class="checkbox-inline"> <?php echo lang('both');?></label>
                                     </div>
                                    <div class="checkbox">
                                    <input type="radio" name="user_gender" id="user_gender" value="MALE"> <label class="checkbox-inline"><?php echo lang('male');?></label>
                                    </div>
                                ...
                                <!-- <label class="col-lg-2 control-label"><?php echo lang('user_name');?></label> -->
                                    ...
                                    <div class="col-lg-10">
                                    <select  class="formcontrol"  multiple="ture" id="user_name" name="user_name[]" style="width:100%;">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-10">
                                        <button type="submit" id="submit" class="btn btn-primary" type="submit">Apply</button>
                                    </div>
                                </div>

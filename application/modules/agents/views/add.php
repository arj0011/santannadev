...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('agents/agents_add') ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" >
                          <div class="form-group">
                                <label class="col-md-3 control-label">
                                    <?php echo lang('select_role');?></label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="full_name" id="full_name" placeholder="<?php echo lang('full_name');?>" />
                                    </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="minus_left custom_chk chk_box">
                                     <div class="checkbox">
                                       <input type="radio" name="gender" id="gender" checked value="MALE"> <label class="checkbox-inline"><?php echo lang('male');?></label>
                                       </div>
                                        <div class="checkbox">
                                        <input type="radio" name="gender" id="gender" value="FEMALE"><label class="checkbox-inline"><?php echo lang('female');?></label>
                                        </div>
                                        </div>
                                    </div>
                                </div>

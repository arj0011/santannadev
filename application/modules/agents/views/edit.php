                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12" >
                               <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('select_role');?></label>
                                    <div class="col-md-9">
                                        <select class="form-control" name="role_name" id="role_name">
                                            ...
                                            <?php if(!empty($roles)){foreach($roles as $role){?>
                                              <option <?php if($results->role_id==$role->id) echo "selected";?> value="<?php echo $role->id;?>"><?php echo $role->name;?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                           ...
                           <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                     ...
                                     <div class="checkbox">
                                        <input type="radio" name="gender" id="gender" <?php if($results->gender=='MALE') echo 'checked="checked"';?> value="MALE"><label class="checkbox-inline"><?php echo lang('male');?></label>
                                        </div>
                                         <div class="checkbox">
                                        <input type="radio" name="gender" id="gender" <?php if($results->gender=='FEMALE') echo 'checked="checked"';?> value="FEMALE"><label class="checkbox-inline"><?php echo lang('female');?></label>
                                        </div>
                                        </div>
                                    </div>
                                </div>

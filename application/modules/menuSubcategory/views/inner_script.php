<script>
    ...
    jQuery('body').on('click', '#submit', function () {
        ...
        $("#"+form_name).validate({
            rules: {
                ...
                menu_subcategory_name_en: "required",
                menu_subcategory_name_el: "required",
            },
            messages: {
                menu_category: '<?php echo lang('menu_category_validation');?>',
                menu_subcategory_name_en: '<?php echo lang('menu_subcategory_name_en_validation');?>',
                menu_subcategory_name_el: '<?php echo lang('menu_subcategory_name_el_validation');?>'
            },
    ...
    $('#common_datatable_menusubcat').dataTable({
      order: [],

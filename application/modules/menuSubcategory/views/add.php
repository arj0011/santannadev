...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('menuSubcategory/menu_subcategory_add') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                       ...
                       <!-- <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <select  class="js-example-basic-multiple"   id="menu_category" name="menu_category[]" multiple="" style="width:100%;">
                         ...
                         <div class="col-md-12" >
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_subcategory_name_en" id="menu_subcategory_name_en" placeholder="<?php echo lang('menu_subcategory_name_en');?>" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="menu_subcategory_name_el" id="menu_subcategory_name_el" placeholder="<?php echo lang('menu_subcategory_name_el');?>" />
                                    </div>

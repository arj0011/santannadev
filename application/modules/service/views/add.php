<style>
 ...
 <!--                          <div class="col-md-6" >
                            ...
                            <div class="col-md-12" >
                              ...
                              <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control closing_sub" data-date-format="hh:ii" data-link-field="dtp_input3" data-link-format="hh:ii"  name="opening" id="opening" placeholder="<?php echo lang('opening');?>" onchange="time_check()"/>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="col-md-6" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control closing_sub2" data-date-format="hh:ii" data-link-field="dtp_input3" data-link-format="hh:ii"  name="closing" id="closing" placeholder="<?php echo lang('closing');?>" onchange="time_check()"/>
                                    </div>
                                </div>
                            </div>
                           </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit"  class="btn btn-primary" id="submit" onclick="time_check()"><?php echo lang('submit_btn');?></button>
                </div>
            </form>
        </div> <!-- /.modal-content -->
    </div><!-- /.modal-dialog -->

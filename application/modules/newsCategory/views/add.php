...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('newsCategory/news_category_add') ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="category_name_en" id="category_name_en" placeholder="<?php echo lang('category_name_en');?>" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="category_name_el" id="category_name_el" placeholder="<?php echo lang('category_name_el');?>" />
                                    </div>

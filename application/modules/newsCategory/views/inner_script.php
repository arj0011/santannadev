<script>
    ...
    jQuery('body').on('click', '#submit', function () {
        ...
        $("#"+form_name).validate({
            rules: {
                ...
                category_name_el: "required",
            },
            messages: {
                category_name_en: '<?php echo lang('category_name_en_validation');?>',
                category_name_el: '<?php echo lang('category_name_el_validation');?>',
            },
    ...
    $('#common_datatable_category').dataTable({
      order: [],

...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url('serviceCategory/service_category_add') ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="service_category_name_en" id="service_category_name_en" />
                                    </div>
                             ...
                             <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="service_category_name_el" id="service_category_name_el" />
                                    </div>

    ...
    jQuery('body').on('click', '#submit', function () {
        ...
        $("#"+form_name).validate({
            rules: {
                ...
                service_category_name_el: "required",
            },
            messages: {
                service_category_name_en: '<?php echo lang('service_category_name_en_validation');?>',
                service_category_name_el: '<?php echo lang('service_category_name_el_validation');?>',
            },
